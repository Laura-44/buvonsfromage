...
wine12 = Drink.create!(name: "Rosé (pressurage direct)", grape: "Cinsault", description: "Léger, fin et soyeux", strength: "11,5%-12,5%", origin: "Provence", color: "Robe claire, de couleur saumon", flavor: "Notes de fleurs et de melon")
wine13 = Drink.create!(name: "Rosé (saignée/macération)", grape: "Grolleau", description: "Onctueux, gras et suave", strength: "11,5%-12,5%", origin: "Val-de-Loire", color: "Robe d'un rosé plus intense, grenadine", flavor: "Arômes de fruits rouges (fraise, framboise, groseille), rose, bonbon anglais, finale toute en fraîcheur")
