...
wine7 = Drink.create!(name: "Muscadet", grape: "Melon Blanc", description: "Vif, léger et aromatique", origin: "Val-de-Loire", strength: "11,5%-12,5%", color: "Blanc", flavor: "Fruits frais : citron/florales : chèvrefeuille")
wine8 = Drink.create!(name: "Savennières", grape: "Chenin Blanc", description: "Vin blanc riche et sec aux arômes de fruits blancs; miellé, rappellant la pomme compotée, le coing, les fleurs blanches", origin: "Val-de-Loire", strength: "12,5%-14%", color: "Blanc", flavor: "Cire d’abeille/alimentaires : miel/florales : acacia, fruits secs et confits : abricot sec")
...
cheese1 = Food.create!(name: "Brie de Meaux jeune", family: "Fromage à pâte molle à croute fleurie", description: "Moelleux et légèrement salé", category_id: category3.id, strength: "Standard", milk: "Vache", aging: "4 semaines minimum", origin: "Seine-et-Marne")
cheese2 = Food.create!(name: "Brie de Meaux affiné", family: "Fromage à pâte molle à croute fleurie", description: "Typé avec l'affinage", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "8 semaines minimum", origin: "Seine-et-Marne")
cheese3 = Food.create!(name: "Neufchatel jeune", family: "Fromage à pâte molle à croute fleurie", description: "Franc, agréable, doux", category_id: category3.id, strength: "Standard", milk: "Vache", aging: "10 jours minimum", origin: "Seine-et-Marne")
cheese4 = Food.create!(name: "Neufchatel affiné", family: "Fromage à pâte molle à croute fleurie", description: "Salé et lactique", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "20 jours minimum", origin: "Seine-et-Marne")
cheese5 = Food.create!(name: "Reblochon", family: "Fromage à pâte pressée non-cuite", description: "Saveur équilibré, ensemble doux et parfumé", category_id: category3.id, strength: "Session", milk: "Vache", aging: "3 semaines minimum", origin: "Savoie, Haute-Savoie")
cheese6 = Food.create!(name: "Saint-Nectaire", family: "Fromage à pâte pressée non-cuite", description: "Franc et légèrement salé", category_id: category3.id, strength: "Session", milk: "Vache", aging: "4 semaines minimum", origin: "Puy de Dôme")
cheese7 = Food.create!(name: "Bleu d'Auvergne", family: "Fromage à pâte persillé", description: "Saveur légèrement salée et texture fondante", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "4 semaines minimum", origin: "Puy de Dôme")
cheese8 = Food.create!(name: "Roquefort", family: "Fromage à pâte persillé", description: "", category_id: category3.id, strength: "Saveur franche, fraîche, fine et prononcée", milk: "Brebis", aging: "3 mois minimum", origin: "Aveyron")
cheese9 = Food.create!(name: "Epoisses", family: "Fromage à pâte molle à croute lavée ", description: "Obligatoirement lavé à l'eau et au marc de Bourgogne", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "4 semaines minimum", origin: "Côte-d'Or, Haute-Marne, Yonne")
cheese10 = Food.create!(name: "Munster", family: "Fromage à pâte molle à croute lavée ", description: "Lactique et végétal. ", category_id: category3.id, strength: "Standard", milk: "Vache", aging: "21 jours minimum", origin: "Alsace")
cheese11 = Food.create!(name: "Maroilles", family: "Fromage à pâte molle à croute lavée ", description: "Lacté, légèrement salé présentant une acidité en pâte ainsi qu'une légère amertume.", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "4 semaines minimum", origin: "Nord")
...
cheese13 = Food.create!(name: "Charolais", family: "Fromage de chèvre ", description: "Crémeux, ferme et lisse.", category_id: category3.id, strength: "Doux", milk: "Chèvre", aging: "2 semaines minimum", origin: "Allier, Loire, Rhône, Saône-et-Loire")
cheese14 = Food.create!(name: "Sainte-Maure-de-Touraine", family: "Fromage de chèvre ", description: "Acidulé et noisetté.", category_id: category3.id, strength: "Doux", milk: "Chèvre", aging: "10 jours minimum", origin: "Indre-et-Loire")
