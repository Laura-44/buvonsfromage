...
cheese2 = Food.create!(name: "Brie de Meaux vieux", family: "Fromage à pâte molle à croute fleurie", description: "Typé avec l'affinage", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "8 semaines minimum", origin: "Seine-et-Marne")
...
cheese4 = Food.create!(name: "Neufchatel vieux", family: "Fromage à pâte molle à croute fleurie", description: "Salé et lactique", category_id: category3.id, strength: "Fort", milk: "Vache", aging: "20 jours minimum", origin: "Seine-et-Marne")
...
cheese9 = Food.create!(name: "Epoisse", family: "Fromage à pâte molle à croute lavée ", description: "Obligatoirement lavé à l'eau et au marc de Bourgogne", category_id: category3.id, strength: "4 semaines minimum", milk: "Vache", aging: "Affiné", origin: "Côte-d'Or, Haute-Marne, Yonne")
